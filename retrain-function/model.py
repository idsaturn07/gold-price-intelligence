...
def train_and_save():
    """Called by Azure Function timer — retrains and saves model artifacts."""
    ...
    if df is None or df.empty:
        logging.warning("yfinance failed after 3 attempts, using fallback data")
...
def get_news_sentiment(country="Global"):
    try:
        ...
        logging.error(f"News sentiment fetch failed: {e}")
        return [], ["Neutral"], [0]
